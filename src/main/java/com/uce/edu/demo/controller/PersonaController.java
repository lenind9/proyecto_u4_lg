...
public class PersonaController {
	...
	@GetMapping("/buscarUno/{idPersona}") //{} = sera una variable con un nombre
	...
	public String actualizarPersona(@PathVariable("idPersona") Integer id, Persona persona) { //el nombre persona debe ser el mismo del th:object en el form
		persona.setId(id);
	...
	//Metodo de redireccionamientos a paginas
	@GetMapping("/nuevaPersona")
	public String paginaNuevaPersona(Persona persona) { //siempre se debe mandar como alrgumento el objeto con el que se va a trabajar, aunque no se lo use
